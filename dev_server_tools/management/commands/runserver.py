...
if not getattr(settings, 'USE_MULTITHREADED_SERVER', False):
    Command = django_runserver.Command
    ...
    from django.core.servers.basehttp import WSGIRequestHandler, WSGIServerException, AdminMediaHandler
